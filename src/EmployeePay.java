...
class Manager5 extends Employee5 {
   ...
   Manager5() {
      ...
      Manager5(String str, double sal, String addr, String dept) {
       super(str, sal, addr);
       department = dept;
   }
     void show() {
...
public class EmployeePay {
	...
	public static void main(String[] args) {
		 Manager5 mgrObj = new Manager5("Henry", 5500.65, "Sydney", "Accounts");
	       double payTotal = mgrObj.totalPay();
	       double less = mgrObj.deduction(5); //no of leaves taken
